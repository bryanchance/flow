...
const (
	workflowName = "fynca-workflow-ffmpeg"
	workflowType = "io.fynca.workflows.ffmpeg"
)

func main() {
	app := cli.NewApp()
	app.Name = workflowName
	app.Usage = "fynca ffmpeg workflow"
	app.Version = "0.1.0"
	...
	app.Flags = []cli.Flag{
		...
		&cli.StringFlag{
			Name:  "ffmpeg-path",
			Usage: "path to ffmpeg executable (default: find in $PATH)",
		},
	}
